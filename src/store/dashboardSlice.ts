...
export const getDashboardData = createAsyncThunk(
  ...
  async (payload: AllUsersPayload | undefined) => {
    return apiInstanceFetch.get(
      `admin/dashboard/allStats?startDate=${payload?.startDate}&endDate=${payload?.endDate}`
    );
  }
);
...
export const getTopDoctorData = createAsyncThunk(
  ...
  async (payload: AllUsersPayload | undefined) => {
    ...
    return apiInstanceFetch.get(
      `admin/dashboard/topDoctors?startDate=${payload?.startDate}&endDate=${payload?.endDate}`
    );
  }
);
...
export const getChartData = createAsyncThunk(
  ...
  async (payload: AllUsersPayload | undefined) => {
    return apiInstanceFetch.get(
      `admin/dashboard/chart?startDate=${payload?.startDate}&endDate=${payload?.endDate}`
    );
  }
);
